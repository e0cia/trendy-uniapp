            ...
            <view class="" style="width: 100%;" @click="tn('../product/product?id='+item.id)">
              ...
              <view class="product-content">
                <view class="image-pic"
                      :style="'background-image:url(' + item.goodImageJson + ');background-size: cover;background-position: center;'">
...
export default {
  ...
  methods: {
    gethomelist() {
      this.$http.getRequest('/kakabl/goods/list?pageNum=1&pageSize=10', {})
          .then(res => {
